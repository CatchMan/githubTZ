...
import com.catchman.githubtesttask.util.loge
...
import com.catchman.githubtesttask.di.component.ActivityComponent
import com.catchman.githubtesttask.di.component.DaggerActivityComponent
import com.catchman.githubtesttask.di.modul.ActivityModule
import com.catchman.githubtesttask.ui.LoadingDialog
import com.catchman.githubtesttask.ui.LoadingView
...
abstract class BaseActivity : AppCompatActivity(), IView, BaseFragment.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityComponent = DaggerActivityComponent.builder()
                ...
                .applicationComponent((application as GitHubApp).appComponent)
                .build()
